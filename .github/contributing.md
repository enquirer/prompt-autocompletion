# Contributing to prompt-autocomplete

First and foremost, thank you! We appreciate that you want to contribute to prompt-autocomplete, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for prompt-autocomplete**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for prompt-autocomplete:

- star the [project](https://github.com/jonschlinkert/prompt-autocomplete)
- tweet your support for prompt-autocomplete
...
- **version**: please note the version of prompt-autocomplete are you using
...
[so]: http://stackoverflow.com/questions/tagged/prompt-autocomplete
